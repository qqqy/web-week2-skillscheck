...
function bigOrSmall (arr){
	let answers = [];
	arr.forEach((val, i) => {
		if(val > 100){answers.push("big")} else {answers.push("small")}
	})
	return answers
}
//////////////////PROBLEM 13////////////////////
...
// Code Here
let doubled = myNumbers.map(val => val*2)
//////////////////PROBLEM 15////////////////////
...
// Code Here
let total = myNumbers.reduce((total, num) => total + num)
//////////////////PROBLEM 17////////////////////
